...
| integration_06_advisor_q06_swiss_gate | advisor_q06_swiss_gate | Swiss final case | pending_advisor_feedback | Swiss nutzt nur deterministisch generierte Final-Case-Artefakte und klare Poll-Proxy-Limitationen. | docs: integrate advisor swiss placement feedback | Keine finale Swiss-Zitation ohne Source Review und Poll-Proxy-Limitation. | Poll-Anteile sind keine Gewinnwahrscheinlichkeiten; keine Effizienz-, Mispricing- oder Tradeability-Behauptung. |

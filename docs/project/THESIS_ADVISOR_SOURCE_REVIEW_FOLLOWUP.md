...
| 7 | followup_07_recheck_final_gates | Final-Gates erneut pruefen | Final Gate Board: 8 Rows; final-ready: 1; final-blocked: 7; blocking count total: 31. | Source Review, Swiss Source-/Citation-Gate, DOCX-Render-QA, review_check und commit_plan vor jedem Abschlussclaim erneut laufen lassen. | Keine finale Abgabebereitschaft behaupten, solange Source Review, Swiss-Gate oder DOCX-Render-QA offen sind. |

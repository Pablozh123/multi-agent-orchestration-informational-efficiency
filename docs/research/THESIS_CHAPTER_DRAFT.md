...
Der Schweizer Abstimmungstrack bleibt bis zum offiziellen Resultat beschreibend. Kernwert: 27 Snapshots; aktuell SRG/gfs.bern Polymarket-Yes 22.0%, Poll-Yes 45.0%, Raw-Gap -23.0 pp. Die aktuelle Figur `data/results/swiss_referendum_10mio_efficiency.png` darf als laufender Poll-Proxy-Vergleich genutzt werden, aber nicht als finaler Effizienzbefund. Poll-Anteile sind keine echten Modellwahrscheinlichkeiten.

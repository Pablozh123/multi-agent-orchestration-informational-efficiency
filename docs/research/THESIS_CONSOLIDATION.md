...
| core_swiss_running_gap_pending | swiss_referendum | Swiss referendum market-poll divergence is descriptive until the result is known. | 42 snapshots; latest SRG/gfs.bern Polymarket Yes 22.5%, poll Yes 45.0%, raw gap -22.5 pp | descriptive_pending_result |

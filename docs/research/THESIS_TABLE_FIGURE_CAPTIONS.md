...
| F4 | figure | fig:f4 | Schweizer 10-Millionen-Initiative: laufender Poll-Proxy-Vergleich | data/results/swiss_referendum_10mio_efficiency.png | discussion_pending_final_result | descriptive_pending_result |
...
| T5 | table | tab:t5 | Statusgrenzen fuer Monitor-Prototyp und Schweizer Abstimmungstrack | data/results/thesis_core_results_table.csv | appendix_or_discussion | mixed_appendix_and_pending |

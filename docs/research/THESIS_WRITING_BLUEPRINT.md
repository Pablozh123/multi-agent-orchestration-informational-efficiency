...
- Swiss referendum market-poll divergence is descriptive until the result is known. Key value: 26 snapshots; latest SRG/gfs.bern Polymarket Yes 22.0%, poll Yes 45.0%, raw gap -23.0 pp Source: `data/results/swiss_referendum_10mio_latest_source_comparison.csv`.

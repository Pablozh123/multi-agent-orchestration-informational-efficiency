...
- Swiss referendum market-poll divergence is descriptive until the result is known. Key value: 43 snapshots; latest SRG/gfs.bern Polymarket Yes 21.5%, poll Yes 45.0%, raw gap -23.5 pp Source: `data/results/swiss_referendum_10mio_latest_source_comparison.csv`.

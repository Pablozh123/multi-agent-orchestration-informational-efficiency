...
def aktualisiere_pilot_signale(
    ...
    Signalstand (Befund 22.07.: letzter Lauf vom 18.07.). Der Watcher
    selbst bleibt read-only und ohne Order-Pfad; gehandelt wird manuell.
    Fehler sind fail-soft: die Kette publiziert dann den letzten Stand.
    """

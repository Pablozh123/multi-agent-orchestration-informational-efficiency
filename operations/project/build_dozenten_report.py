...
def _thesis_highlevel_data(
    ...
    return {
        ...
        "rows": [
            ...
            (
                "Monitor und Swiss",
                "Monitor bleibt Prototype/Appendix; Swiss ist nach offiziellem Ergebnis als bounded Side-Track gemappt.",
...
def _project_highlevel_report_data(project_highlevel: pd.DataFrame) -> dict[str, Any]:
    ...
    status_labels = {
        ...
        "post_result_mapped_bounded": "Post-Resultat bounded",
    ...
    decision_labels = {
        ...
        "project_07_swiss_referendum": "Als bounded Post-Resultat-Fallstudie verwenden; keine Effizienz- oder Tradeability-Claims.",
    ...
    gate_labels = {
        ...
        "project_07_swiss_referendum": "Source Review und finale Zitierformulierung vor finalem Swiss-Abschnitt klaeren.",

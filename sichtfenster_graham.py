"""Live-Sichtfenster Graham-Lauf: folgt bot_events.jsonl und zeigt
je Chunk die angeschlagenen Zaehler, Marker, Verify und Kaeufe.
Start per sichtfenster_graham.cmd (Doppelklick)."""
import json
import time
from pathlib import Path

PFAD = Path(__file__).parent / "data/live/trump_graham_july28/bot_events.jsonl"

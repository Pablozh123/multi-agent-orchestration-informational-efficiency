...
\section{Forschungsdesign: deterministischer Kern vor Interpretation}
...
RealClearPolitics & \texttt{poll\_forecasts} & 0 Zeilen & standardmässig ausgeschlossen \\
...
\section{Operationalisierung der Hypothesen}

\subsection{H1 --- Prognosequalität}
...
\section{Reproduzierbarkeit und Guardrails}
...
Sprachmodell-Aufruf muss protokolliert werden. Diese Disziplin macht jede
thesis-relevante Kennzahl rerunnbar und prüfbar und ist damit selbst ein
